...
class objekt
	...
	public:
		objekt(){ clear();}
		~objekt(){ reset();}
		void get_pos(D3DXVECTOR3 &vPos){vPos.x=transform._41; vPos.y=transform._42; vPos.z=transform._43;}
		void set_pos(D3DXVECTOR3 &vPos){transform._41=vPos.x; transform._42=vPos.y; transform._43=vPos.z;}
